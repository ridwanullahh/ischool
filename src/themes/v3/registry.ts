...
import luminaClassDetailPage from './lumina/ClassDetailPage.astro';
...
import crestClassDetailPage from './crest/ClassDetailPage.astro';
...
import marbleClassDetailPage from './marble/ClassDetailPage.astro';
...
import driftClassDetailPage from './drift/ClassDetailPage.astro';
...
import forgeClassDetailPage from './forge/ClassDetailPage.astro';
...
import haloClassDetailPage from './halo/ClassDetailPage.astro';
...
import cascadeClassDetailPage from './cascade/ClassDetailPage.astro';
...
import horizonClassDetailPage from './horizon/ClassDetailPage.astro';
...
import emberClassDetailPage from './ember/ClassDetailPage.astro';
...
import harmonyClassDetailPage from './harmony/ClassDetailPage.astro';
...
const registry: Record<string, RegisteredTheme> = {
  ...
  lumina: { config: luminaConfig, Layout: luminaLayout, HomePage: luminaHomePage, AboutPage: luminaAboutPage, AdmissionsPage: luminaAdmissionsPage, ProgramsPage: luminaProgramsPage, ProgramDetailPage: luminaProgramDetailPage, ClassesPage: luminaClassesPage, ClassDetailPage: luminaClassDetailPage, BlogIndexPage: luminaBlogIndexPage, BlogPostPage: luminaBlogPostPage, AnnouncementsIndexPage: luminaAnnouncementsIndexPage, AnnouncementDetailPage: luminaAnnouncementDetailPage, GalleryPage: luminaGalleryPage, FaqsPage: luminaFaqsPage, ContactPage: luminaContactPage },
  crest: { config: crestConfig, Layout: crestLayout, HomePage: crestHomePage, AboutPage: crestAboutPage, AdmissionsPage: crestAdmissionsPage, ProgramsPage: crestProgramsPage, ProgramDetailPage: crestProgramDetailPage, ClassesPage: crestClassesPage, ClassDetailPage: crestClassDetailPage, BlogIndexPage: crestBlogIndexPage, BlogPostPage: crestBlogPostPage, AnnouncementsIndexPage: crestAnnouncementsIndexPage, AnnouncementDetailPage: crestAnnouncementDetailPage, GalleryPage: crestGalleryPage, FaqsPage: crestFaqsPage, ContactPage: crestContactPage },
  ...
  marble: { config: marbleConfig, Layout: marbleLayout, HomePage: marbleHomePage, AboutPage: marbleAboutPage, AdmissionsPage: marbleAdmissionsPage, ProgramsPage: marbleProgramsPage, ProgramDetailPage: marbleProgramDetailPage, ClassesPage: marbleClassesPage, ClassDetailPage: marbleClassDetailPage, BlogIndexPage: marbleBlogIndexPage, BlogPostPage: marbleBlogPostPage, AnnouncementsIndexPage: marbleAnnouncementsIndexPage, AnnouncementDetailPage: marbleAnnouncementDetailPage, GalleryPage: marbleGalleryPage, FaqsPage: marbleFaqsPage, ContactPage: marbleContactPage },
  ...
  drift: { config: driftConfig, Layout: driftLayout, HomePage: driftHomePage, AboutPage: driftAboutPage, AdmissionsPage: driftAdmissionsPage, ProgramsPage: driftProgramsPage, ProgramDetailPage: driftProgramDetailPage, ClassesPage: driftClassesPage, ClassDetailPage: driftClassDetailPage, BlogIndexPage: driftBlogIndexPage, BlogPostPage: driftBlogPostPage, AnnouncementsIndexPage: driftAnnouncementsIndexPage, AnnouncementDetailPage: driftAnnouncementDetailPage, GalleryPage: driftGalleryPage, FaqsPage: driftFaqsPage, ContactPage: driftContactPage },
  forge: { config: forgeConfig, Layout: forgeLayout, HomePage: forgeHomePage, AboutPage: forgeAboutPage, AdmissionsPage: forgeAdmissionsPage, ProgramsPage: forgeProgramsPage, ProgramDetailPage: forgeProgramDetailPage, ClassesPage: forgeClassesPage, ClassDetailPage: forgeClassDetailPage, BlogIndexPage: forgeBlogIndexPage, BlogPostPage: forgeBlogPostPage, AnnouncementsIndexPage: forgeAnnouncementsIndexPage, AnnouncementDetailPage: forgeAnnouncementDetailPage, GalleryPage: forgeGalleryPage, FaqsPage: forgeFaqsPage, ContactPage: forgeContactPage },
  halo: { config: haloConfig, Layout: haloLayout, HomePage: haloHomePage, AboutPage: haloAboutPage, AdmissionsPage: haloAdmissionsPage, ProgramsPage: haloProgramsPage, ProgramDetailPage: haloProgramDetailPage, ClassesPage: haloClassesPage, ClassDetailPage: haloClassDetailPage, BlogIndexPage: haloBlogIndexPage, BlogPostPage: haloBlogPostPage, AnnouncementsIndexPage: haloAnnouncementsIndexPage, AnnouncementDetailPage: haloAnnouncementDetailPage, GalleryPage: haloGalleryPage, FaqsPage: haloFaqsPage, ContactPage: haloContactPage },
...
'zenith': { config: zenithConfig, Layout: zenithLayout, HomePage: zenithHomePage, AboutPage: zenithAboutPage, AdmissionsPage: zenithAdmissionsPage, ProgramsPage: zenithProgramsPage, ProgramDetailPage: zenithProgramDetailPage, ClassesPage: zenithClassesPage, BlogIndexPage: zenithBlogIndexPage, BlogPostPage: zenithBlogPostPage, AnnouncementsIndexPage: zenithAnnouncementsIndexPage, AnnouncementDetailPage: zenithAnnouncementDetailPage, GalleryPage: zenithGalleryPage, FaqsPage: zenithFaqsPage, ContactPage: zenithContactPage },
  ...
  'horizon': { config: horizonConfig, Layout: horizonLayout, HomePage: horizonHomePage, AboutPage: horizonAboutPage, AdmissionsPage: horizonAdmissionsPage, ProgramsPage: horizonProgramsPage, ProgramDetailPage: horizonProgramDetailPage, ClassesPage: horizonClassesPage, ClassDetailPage: horizonClassDetailPage, BlogIndexPage: horizonBlogIndexPage, BlogPostPage: horizonBlogPostPage, AnnouncementsIndexPage: horizonAnnouncementsIndexPage, AnnouncementDetailPage: horizonAnnouncementDetailPage, GalleryPage: horizonGalleryPage, FaqsPage: horizonFaqsPage, ContactPage: horizonContactPage },
  ...
  'ember': { config: emberConfig, Layout: emberLayout, HomePage: emberHomePage, AboutPage: emberAboutPage, AdmissionsPage: emberAdmissionsPage, ProgramsPage: emberProgramsPage, ProgramDetailPage: emberProgramDetailPage, ClassesPage: emberClassesPage, ClassDetailPage: emberClassDetailPage, BlogIndexPage: emberBlogIndexPage, BlogPostPage: emberBlogPostPage, AnnouncementsIndexPage: emberAnnouncementsIndexPage, AnnouncementDetailPage: emberAnnouncementDetailPage, GalleryPage: emberGalleryPage, FaqsPage: emberFaqsPage, ContactPage: emberContactPage },
