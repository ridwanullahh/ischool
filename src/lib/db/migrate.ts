...
export function migrate() {
  ...
  const newTables = `
    ...
    CREATE TABLE IF NOT EXISTS hostel_checkins (
      ...
      type TEXT NOT NULL, timestamp TEXT NOT NULL, notes TEXT,
    ...
    CREATE TABLE IF NOT EXISTS hostel_visitors (
      ...
      time_in TEXT NOT NULL, time_out TEXT, purpose TEXT, notes TEXT,
      recorded_by INTEGER REFERENCES users(id), created_at INTEGER, updated_at INTEGER
    );
    CREATE TABLE IF NOT EXISTS hostel_maintenance_requests (
      ...
      status TEXT NOT NULL DEFAULT 'pending', reported_by INTEGER REFERENCES users(id),
