...
export const payments = sqliteTable('payments', {
  ...
  schoolId: integer('school_id').notNull().references(() => schools.id, { onDelete: 'cascade' }),
  amount: integer('amount').notNull(),
  method: text('method', { enum: ['cash', 'bank_transfer', 'stripe', 'paystack', 'flutterwave', 'paypal', 'birrpay', 'other'] }).notNull(),
...
export const platformPayments = sqliteTable('platform_payments', {
  ...
  amount: integer('amount').notNull(),
  currency: text('currency').notNull().default('USD'),
  gateway: text('gateway', { enum: ['stripe', 'paypal', 'paystack', 'flutterwave', 'birrpay', 'coupon', 'manual', 'bank_transfer'] }).notNull(),
...
export const admissionPeriods = sqliteTable('admission_periods', {
  ...
  description: text('description'),
  // Extended details for the opening
  eligibleGrades: text('eligible_grades'),
  ...
  requirements: text('requirements', { mode: 'json' }).default('[]'),
  processSteps: text('process_steps', { mode: 'json' }).default('[]'),
  importantDates: text('important_dates', { mode: 'json' }).default('[]'),
  contactEmail: text('contact_email'),
  contactPhone: text('contact_phone'),
  brochureUrl: text('brochure_url'),
  faqLink: text('faq_link'),
  isActive: integer('is_active', { mode: 'boolean' }).default(true),
